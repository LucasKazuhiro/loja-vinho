...
export class PesquisaComponent {
  ...
  constructor(){
    ...
    this.vinhosFiltrado = [
      ...
      ].filter(vinho => vinho.nome.toLocaleLowerCase().includes(this.pesquisaValorVinho.toLocaleLowerCase()));
  }
