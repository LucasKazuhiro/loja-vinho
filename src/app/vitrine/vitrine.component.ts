...
export class VitrineComponent {
  public vinhos:Vinho[] = [
    ...
    {codigo:4, nome:"Concha y Toro Gran reserva Cabernet Sauvignon",  tipo:"Tinto",   uva:"Cabernet Sauvignon", volume:750, teorAlcoolico:13.5, marca:"Casillero del Diablo", cdPais:"2",    pais:"Chile",     regiao:"Vale de Colchagua", preco:59.90,  estoque:10, desconto:0},
    ...
    {codigo:17, nome:"Miolo Lote 43 ",                                tipo:"Tinto",   uva:"Cabernet Sauvignon, Merlot",       volume:750, teorAlcoolico:14,   marca:"Salentein",                  cdPais:"1",  pais:"Argentina", regiao:"Mendoza",   preco:109.00,  estoque:10, desconto:0.13},
